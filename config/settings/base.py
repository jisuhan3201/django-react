...
MIGRATION_MODULES = {
    'sites': 'wizwid_app.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'wizwid_app.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'wizwid_app.users.adapters.SocialAccountAdapter'
